        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-sky-900 text-center">
                    <form method="POST" action="{{route('manager.users.store')}}" class="md:w-2/4 mx-auto bg-sky-100 px-6 py-8 rounded">
                        <a href="{{route('manager.users.index')}}" class="text-lg text-blue-700 hover:text-blue-900">اضافة مستخدم</a>
                        @csrf
                        <div class="mb-2">
